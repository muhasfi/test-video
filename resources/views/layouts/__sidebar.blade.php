            ...
            <div class="sidebar-wrapper active">
                ...
                <ul class="menu">
                    ...
                    @if(auth()->user()->role === 'admin')
                        <li class="sidebar-item has-sub {{ request()->routeIs('users.index', 'videos.index') ? 'active' : '' }}">
                            <a href="#" class="sidebar-link">
                                <i class="bi bi-stack"></i>
                                <span>Master</span>
                            </a>

                            <ul class="submenu {{ request()->routeIs('users.index', 'videos.index') ? 'active' : '' }}">
                                ...
                                <li class="submenu-item {{ request()->routeIs('videos.index') ? 'active' : '' }}">
                        ...
                        <li class="sidebar-item {{ request()->routeIs('approve-requests') ? 'active' : '' }}">
                            <a href="{{ route('approve.requests') }}" class="sidebar-link">
                    ...
                    <li class="sidebar-item {{ request()->routeIs('daftar-video') ? 'active' : '' }}">
                        <a href="{{ route('daftar-video') }}" class="sidebar-link">
